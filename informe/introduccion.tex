...
\begin{itemize}
  \caracteristica{componentes visuales} rompiendo con el estereotipo de la pantalla negra con mucho texto, estas herramientas hacen fuerte uso de distintos recursos visuales (imágenes, animaciones, gráficos, etc) como medio para transmitir ideas y ejecutar algoritmos.

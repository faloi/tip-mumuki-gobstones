...
\subsection{Chequeo de expectativas}
...
Al haber delegado la ejecución de las pruebas, sólo resta implementar el chequeo de expectativas y ejecutar todo en el \codigo{run\_test\_command}.

...
\begin{listing}
  ...
  \caption{Ejemplo de un test sencillo, que chequea únicamene la posición del cabezal.}
  \label{lst:CabezalSpec}
\end{listing}

\borrador{Contar cuáles son los componentes de un test (subject, check head position, examples, valores de retorno, parámetros). Mostrar un test de ejemplo.}

Un ejemplo de esto puede verse en la figura \ref{lst:CabezalSpec}.
